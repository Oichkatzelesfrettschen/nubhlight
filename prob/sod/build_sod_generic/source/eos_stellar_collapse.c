...
// Serial HDF5 builds do not provide the MPI-IO API. For local development
// environments where only serial HDF5 is available, compile these calls as
// no-ops. When built against parallel HDF5, `H5_HAVE_PARALLEL` is defined and
// the real MPI-IO routines are used.
#ifndef H5_HAVE_PARALLEL
#ifndef H5FD_MPIO_COLLECTIVE
#define H5FD_MPIO_COLLECTIVE 0
#endif
#define H5Pset_fapl_mpio(...) do { } while (0)
#define H5Pset_dxpl_mpio(...) do { } while (0)
#endif
